                    ...
                    <div class="flex items-center justify-between mb-8">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Real-time data collection status and recent measurements</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    <div class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-10 translate-x-10"></div>
                                    <div class="relative z-10">
                                        <div class="flex items-center justify-between mb-3">
                                            <i class="fas fa-clock text-blue-100 text-lg"></i>
                                            <span class="text-xs bg-blue-400/30 px-2 py-1 rounded-full">24h</span>
                                        </div>
                                        <div class="text-2xl font-bold mb-1">
                                            <?php echo !empty($hourlyData) ? count($hourlyData) : '0'; ?>
                                        </div>
                                        <div class="text-blue-100 text-sm">Hourly Records</div>
                                    </div>
                                </div>
                                
                                <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    <div class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-10 translate-x-10"></div>
                                    <div class="relative z-10">
                                        <div class="flex items-center justify-between mb-3">
                                            <i class="fas fa-calendar text-emerald-100 text-lg"></i>
                                            <span class="text-xs bg-emerald-400/30 px-2 py-1 rounded-full">7d</span>
                                        </div>
                                        <div class="text-2xl font-bold mb-1">
                                            <?php echo !empty($dailyData) ? count($dailyData) : '0'; ?>
                                        </div>
                                        <div class="text-emerald-100 text-sm">Daily Records</div>
                                    </div>
                                </div>
                                
                                <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    <div class="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-10 translate-x-10"></div>
                                    <div class="relative z-10">
                                        <div class="flex items-center justify-between mb-3">
                                            <i class="fas fa-satellite text-purple-100 text-lg"></i>
                                            <span class="text-xs bg-purple-400/30 px-2 py-1 rounded-full">Now</span>
                                        </div>
                                        <div class="text-2xl font-bold mb-1">
                                            <?php echo !empty($latest) ? '✓' : '✗'; ?>
                                        </div>
                                        <div class="text-purple-100 text-sm">Latest Reading</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center justify-between mb-3">
                                    <h4 class="font-semibold text-gray-900 dark:text-white text-sm">Data Quality Score</h4>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">Last 24h</span>
                                </div>
                                <div class="flex items-center space-x-3">
                                    <div class="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                        <div class="bg-gradient-to-r from-green-400 to-blue-500 h-2 rounded-full" style="width: 98.5%"></div>
                                    </div>
                                    <span class="text-sm font-semibold text-gray-900 dark:text-white">98.5%</span>
                                </div>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Excellent data collection reliability</p>
                            </div>
                        </div>

                        <!-- Right Column: Enhanced Data Table -->
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    <span class="text-xs bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 px-2 py-1 rounded-full">
                                        Latest 5 of <?php echo count($hourlyData); ?>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-lg">
                                <div class="overflow-x-auto">
                                    <table class="min-w-full">
                                        <thead class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                                            <tr>
                                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">
                                                    <i class="fas fa-clock mr-1"></i>Time
                                                </th>
                                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">
                                                    <i class="fas fa-filter mr-1"></i>Turbidity
                                                </th>
                                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">
                                            ...
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100">
                                                    <div class="flex items-center space-x-2">
                                                        ...
                                                        <span class="font-mono text-sm"><?php echo date('H:i:s', strtotime($row['reading_time'])); ?></span>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-3">
                                                    <div class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-gradient-to-r from-blue-100 to-blue-200 dark:from-blue-900/40 dark:to-blue-800/40 text-blue-800 dark:text-blue-200 border border-blue-200 dark:border-blue-700">
                                                        <i class="fas fa-filter mr-1.5 text-xs"></i>
                                                        <?php echo number_format($row['turbidity'], 2); ?> NTU
                                                    </div>
                                                </td>
                                                <td class="px-4 py-3">
                                                    <div class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-gradient-to-r from-emerald-100 to-emerald-200 dark:from-emerald-900/40 dark:to-emerald-800/40 text-emerald-800 dark:text-emerald-200 border border-emerald-200 dark:border-emerald-700">
                                                        <i class="fas fa-flask mr-1.5 text-xs"></i>
                                                        <?php echo number_format($row['tds'], 2); ?> ppm
                                                    </div>
                                                </td>
                                                <td class="px-4 py-3">
                                                    <div class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-gradient-to-r from-purple-100 to-purple-200 dark:from-purple-900/40 dark:to-purple-800/40 text-purple-800 dark:text-purple-200 border border-purple-200 dark:border-purple-700">
                                                        <i class="fas fa-vial mr-1.5 text-xs"></i>
                                                        <?php echo number_format($row['ph'], 2); ?>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-3">
                                                    <div class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-gradient-to-r from-red-100 to-red-200 dark:from-red-900/40 dark:to-red-800/40 text-red-800 dark:text-red-200 border border-red-200 dark:border-red-700">
                                                        <i class="fas fa-thermometer-half mr-1.5 text-xs"></i>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900/50 px-4 py-3 border-t border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400">
                                        <span>Data collected every second • Last updated: <?php echo date('H:i:s'); ?></span>
                                        <span class="flex items-center space-x-1">
                                            <i class="fas fa-database text-indigo-500"></i>
                                            <span>Total: <?php echo count($hourlyData); ?> records</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <?php else: ?>
                            <div class="bg-white dark:bg-gray-800 rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-600 p-8 text-center">
                                <div class="w-16 h-16 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <i class="fas fa-database text-gray-400 text-xl"></i>
                                </div>
                                <h4 class="text-gray-900 dark:text-white font-medium mb-2">No Data Available</h4>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Recent measurements will appear here once data collection begins.</p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
