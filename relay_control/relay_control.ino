...
// WiFi credentials
const char* ssid = "Ochea Family 2.4Ghz";
const char* password = "Yukira_1209";

// Server details
const char* serverUrl = "http://192.168.1.59/projtest/upload.php";
const char* relayControlUrl = "http://192.168.1.59/projtest/relay_control.php";
