...
CREATE TABLE `automation_settings` (
  ...
  `turbidity_critical_min` float NOT NULL DEFAULT 10.0 COMMENT 'Turbidity critical minimum threshold (NTU)',
  `turbidity_critical_max` float NOT NULL DEFAULT 50.0 COMMENT 'Turbidity critical maximum threshold (NTU)',
  `turbidity_medium_min` float NOT NULL DEFAULT 5.0 COMMENT 'Turbidity medium minimum threshold (NTU)',
  `turbidity_medium_max` float NOT NULL DEFAULT 10.0 COMMENT 'Turbidity medium maximum threshold (NTU)',
